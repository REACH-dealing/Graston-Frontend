    ...
    <div>
      ...
      <form>
        ...
        <div className='d-flex flex-column mt-4 '>
          ...
          <div className='d-flex align-items-center phoneCode'>
        ...
        <h6 className='mt-4'>OR</h6>
              <Button variant='light' className='fw-bolder d-block w-100 googleBtn mt-4'><img src='/assets/Vector (1).png' className='me-3' width={'22px'} alt='google'/>Login With Google</Button>
